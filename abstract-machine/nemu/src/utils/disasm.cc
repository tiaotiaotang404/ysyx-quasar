...
#include "llvm/MC/TargetR_istry.h"
#if LLVM_VERSION_MAJOR >= 15
#include "llvm/MC/MCSubtargetInfo.h"
#endif
#else
#include "llvm/Support/TargetR_istry.h"
#endif
...
extern "C" void init_disasm(const char *triple) {
  ...
  llvm::MCR_isterInfo *gMRI = nullptr;
  auto target = llvm::TargetR_istry::lookupTarget(gTriple, errstr);
  if (!target) {
  ...
  gMRI = target->createMCR_Info(gTriple);
